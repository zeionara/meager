...
INT readTriples(
    File* file, bool enable_filters, TripleFilter<INT>* filter, TripleEncoder<INT>* encoder, Triple* tripleList, TripleIndex* tripleIndex
	...
	for (INT i = 0; i < 19; i++) { // Reading train samples
        INT h, r, t;
